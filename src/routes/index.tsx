...
import { RouteErrorBoundary, MessagesErrorBoundary, PayErrorBoundary } from '../components/ErrorBoundary';
...
const ZeniLanding = lazy(() => import('../pages/ZeniLanding').then((m) => ({ default: m.ZeniLanding })));
const PublicMapPage = lazy(() => import('../pages/PublicMap').then((m) => ({ default: m.PublicMapPage })));
const PublicExplorePage = lazy(() => import('../pages/PropertyListingsPage').then((m) => ({ default: m.PropertyListingsPage })));
...
const ExplorePage = lazy(() => import('../pages/user/Explore').then((m) => ({ default: m.ExplorePage })));
const InventoryPage = lazy(() => import('../pages/user/Inventory').then((m) => ({ default: m.InventoryPage })));
const SavedPage = lazy(() => import('../pages/user/Saved').then((m) => ({ default: m.SavedPage })));
const MessagesLayout = lazy(() => import('../pages/messages/Layout').then((m) => ({ default: m.MessagesLayout })));
const InboxPage = lazy(() => import('../pages/messages/Inbox').then((m) => ({ default: m.InboxPage })));
const ThreadPage = lazy(() => import('../pages/messages/Thread').then((m) => ({ default: m.ThreadPage })));
const ProfilePage = lazy(() => import('../pages/user/Profile').then((m) => ({ default: m.ProfilePage })));
const ViewingsPage = lazy(() => import('../pages/user/Viewings').then((m) => ({ default: m.ViewingsPage })));
const RefundsPage = lazy(() => import('../pages/user/Refunds').then((m) => ({ default: m.RefundsPage })));
const PropertyDetailsPage = lazy(() => import('../pages/PropertyDetails').then((m) => ({ default: m.PropertyDetailsPage })));

const DashboardPage = lazy(() => import('../pages/agent/Dashboard').then((m) => ({ default: m.DashboardPage })));
const AgentListingsPage = lazy(() => import('../pages/agent/Listings').then((m) => ({ default: m.ListingsPage })));
const LeadsPage = lazy(() => import('../pages/agent/Leads').then((m) => ({ default: m.LeadsPage })));
const AnalyticsPage = lazy(() => import('../pages/agent/Analytics').then((m) => ({ default: m.AnalyticsPage })));
const ListingEditorPage = lazy(() => import('../pages/agent/ListingEditor').then((m) => ({ default: m.ListingEditorPage })));
const AgentViewingsPage = lazy(() => import('../pages/agent/Viewings').then((m) => ({ default: m.AgentViewingsPage })));
const AgentVerificationPage = lazy(() => import('../pages/agent/Verification').then((m) => ({ default: m.AgentVerificationPage })));
const BoostPage = lazy(() => import('../pages/agent/BoostPage').then((m) => ({ default: m.BoostPage })));
const AgentSettingsPage = lazy(() => import('../pages/agent/Settings').then((m) => ({ default: m.AgentSettingsPage })));
...
const AdminListingsPage = lazy(() => import('../pages/admin/Listings').then((m) => ({ default: m.ListingsPage })));
...
const NetworkAccessPage = lazy(() => import('../pages/admin/NetworkAccess').then((m) => ({ default: m.NetworkAccessPage })));
const AdminRefundRequestsPage = lazy(() => import('../pages/admin/RefundRequests').then((m) => ({ default: m.RefundRequestsPage })));

const PayRouter = lazy(() => import('../pay/PayRouter').then((m) => ({ default: m.PayRouter })));
const NotFoundPage = lazy(() => import('../pages/NotFound').then((m) => ({ default: m.NotFoundPage })));
const NeighborhoodPage = lazy(() => import('../pages/NeighborhoodPage').then((m) => ({ default: m.default })));
    ...
    <Suspense fallback={<ZeniLoading />}>
      <Routes>
        ...
        <Route
          ...
          <Route path="home" element={<RequireAuth><RequireRole roles={['user']} redirectToRole><HomePage /></RequireRole></RequireAuth>} />

          {/* Public Routes (Discovery) */}
          <Route path="explore" element={<ExplorePage />} />
          <Route path="listing/:id" element={<Navigate to={`/listing/${"id"}`} replace />} /> {/* Redirect old /app/listing to root /listing */}

          {/* Private Post-Login Routes */}
          <Route element={<RequireAuth><RequireRole roles={['user']} redirectToRole><Outlet /></RequireRole></RequireAuth>}>
            <Route path="inventory" element={<InventoryPage />} />
            <Route path="saved" element={<SavedPage />} />
            <Route path="viewings" element={<ViewingsPage />} />
            <Route path="refunds" element={<RefundsPage />} />
            <Route path="messages" element={<MessagesErrorBoundary><MessagesLayout /></MessagesErrorBoundary>}>
        ...
        <Route
          ...
          element={
            <RouteErrorBoundary routeName="Pay portal">
              <PayErrorBoundary>
                <Suspense fallback={<div className="p-6 text-sm text-neutral-500">Loading pay...</div>}>
                  <PayRouter />
                </Suspense>
              </PayErrorBoundary>
            </RouteErrorBoundary>
