...
const CATEGORIES = [
  ...
  { value: 'misleading', label: '📸 Misleading info', desc: 'Wrong photos, location, or details' },
  {
    ...
    desc: 'Same property posted multiple times',
  },
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      push({
        ...
        description: "We'll review this listing within 24 hours.",
        tone: 'success',
      });
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    {CATEGORIES.map((cat, idx) => (
                      <button
                        ...
                        className={`flex items-start gap-3 px-4 py-3 rounded-xl border text-left transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 ${
                          category === cat.value
                        ...
                        <div className="flex-shrink-0 mt-0.5">
                          <div
                            className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                              category === cat.value ? 'border-red-500' : 'border-zinc-300'
                            }`}
                          >
                            {category === cat.value && (
