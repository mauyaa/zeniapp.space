      ...
      {open && (
        <div className="px-4 pb-5 space-y-4 border-t border-zinc-100">
          ...
          <div className="pt-4 rounded-lg bg-green-50 border border-green-100 px-4 py-3 text-center">
            ...
            <p className="text-2xl font-bold font-mono text-green-800">{formatKES(monthly)}</p>
          ...
          <p className="text-[9px] text-zinc-400 leading-relaxed">
            * Indicative estimate only. Actual payments depend on your lender's terms, insurance,
            and applicable taxes. Consult your bank or SACCO for a formal quote.
          </p>
        </div>
      )}
    </div>
