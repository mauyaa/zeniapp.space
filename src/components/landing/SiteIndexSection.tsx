...
export function SiteIndexSection() {
  return (
    <div className="grid gap-10 lg:grid-cols-[1fr,2fr]">
      <div>
        <div className="text-xs uppercase tracking-[0.3em] text-[rgb(var(--muted))]">Driven by trust.</div>
      ...
      <div className="grid gap-6 sm:grid-cols-3">
        {columns.map((column) => (
          <div key={column.title} className="space-y-3">
            <div className="text-xs uppercase tracking-[0.25em] text-[rgb(var(--muted))]">{column.title}</div>
