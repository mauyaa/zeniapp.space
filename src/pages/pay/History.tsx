...
const tx = [
  { id: 'tx-1', invoiceId: 'inv-099', amount: 'KES 25,000', status: 'paid' as const, when: 'Jan 12, 10:04', method: 'M-Pesa' },
  { id: 'tx-2', invoiceId: 'inv-101', amount: 'KES 25,000', status: 'pending' as const, when: 'Feb 2, 09:20', method: 'M-Pesa' }
];
    ...
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <p className="text-[10px] uppercase tracking-[0.24em] text-slate-500 mb-1">Transactions</p>
            <h1 className="text-xl font-semibold text-slate-100">Payment history</h1>
            <p className="text-sm text-slate-400 mt-1">All your past payments and pending transactions.</p>
          </div>
