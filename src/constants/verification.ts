...
export const AGENT_ONBOARDING_PROTOCOL = [
  {
    step: 1,
    title: 'Start as a user',
    description:
      'Create a Zeni account and use the platform as a buyer or renter. Browse listings, save favorites, and message agents.',
  },
  {
    step: 2,
    title: 'Apply to become an agent',
    description:
      'From your profile or the agent application flow, submit a request to join as an agent. You will need your EARB registration number and identity documents.',
  },
  {
    step: 3,
    title: 'Submit evidence',
    description:
      'Upload your EARB details and verification evidence (ID, license). Our team will review your application.',
  },
  {
    step: 4,
    title: 'Admin review',
    description:
      'An admin verifies your EARB number against the official portal and reviews your documents. This usually takes 1–2 business days.',
  },
  {
    step: 5,
    title: 'Approved as agent',
    description:
      'Once accepted, your account is upgraded to agent access. You can list properties, manage viewings, and use agent tools.',
  },
] as const;

/** Short label for when KYC is required (for UI). */
export const KYC_REQUIRED_LABEL =
  'Required to buy, pay for land, or receive payouts. Not required to browse or view listings.';
